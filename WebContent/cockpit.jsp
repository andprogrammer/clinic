...
<% if(request.getAttribute("action")!=null) {
		...
		if(action.equals("success")) { %>
			<br>Poprawnie dokonano zmian.</br>		
	 <%	} else { %>
	 	<br>Blad : <%=action %></br>
	 <%	} 
	} else { %>
	...
	<fieldset><br/>
		<table style="text-align: right;">
			<tr style="text-align: center;"><td colspan=2><h3>Podstawowe informacje:</h3></td><td>			
			<tr><td>imie: </td><td><input type="text" style="width:220px" name="first_name" value="<%=first_name%>"></td></tr>
			<tr><td>nazwisko: </td><td><input type="text" style="width:220px" name="last_name" value="<%=last_name%>"></td></tr>
			<tr><td>nr pesel: </td><td><input type="text" style="width:220px" name="pesel" value="<%=pesel%>"></td></tr>
			
			<tr style="text-align: center;"><td colspan=2><h3>Logowanie:</h3></td><td>
			<tr><td>email: </td><td><input type="text" style="width:220px" name="email" value="<%=email %>"></td></tr>
			<tr><td>haslo: </td><td><input type="password" style="width:220px" name="password" value="<%=password %>"/></td></tr>
		</table>
